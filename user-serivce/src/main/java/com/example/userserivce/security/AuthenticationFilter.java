...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            return getAuthenticationManager().authenticate(new UsernamePasswordAuthenticationToken( // 이메일과 패스워드를 JWT로 만든다.
                    creds.getEmail(),
                    creds.getPwd(),
                    new ArrayList<>()
                    )
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        UserDto userDetails = userService.getUserDetailByEmail(userId);
        ...
        String toekn = Jwts.builder()
                ...
                .compact();
        response.addHeader("token", toekn);
